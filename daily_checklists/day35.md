...
### Key Resources:
- [ ] [Curriculum Details](../DAILY_BREAKDOWN.md) - Day 35
...
### Setup & Preparation
- [ ] Create notebook/script: `day35_semantic_segmentation.ipynb`
...
- [ ] **Task 1:** Segmentation
- [ ] **Task 2:** U-Net
- [ ] **Task 3:** Pixel-wise classification
...
## 🚀 Mini Project: Segmentation model
...
```
🚀 Day 35/100 of #100DaysOfAIEngineer!
...
Project: Segmentation model

Key learning: [Share your biggest insight]

#Segmentation #CV #MachineLearning #AI #100DaysOfCode #LearningInPublic
...
#Segmentation #CV #AI #100DaysOfCode
```

**LinkedIn (Professional):**

```
Day 35 of my 100-day AI Engineering journey! 🎯
...
Today's project: Segmentation model
...
#Segmentation #CV #ArtificialIntelligence #MachineLearning #ProfessionalDevelopment
...
[← Day 34](day34.md) | [Back to Index](README.md) | [Day 36 →](day36.md)

---

**Great work on Day 35! Keep pushing forward!** 💪🔥
